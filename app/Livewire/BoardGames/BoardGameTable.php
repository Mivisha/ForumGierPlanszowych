    ...
    public function actions(BoardGame $row): array
    {
        return [
            ...
            Button::add('delete')
                ...
                ->id()
                ->class('pg-btn-white text-red-500 dark:ring-pg-primary-600 dark:border-pg-primary-600 dark:hover:bg-red-700 dark:hover:text-white dark:ring-offset-pg-primary-800')
                ->tooltip(__('boardgames.actions.delete'))
                ->dispatch('delete', ['rowId' => $row->id])
                ->confirm('Are you sure you want to delete this board game?')
        ];
    }
