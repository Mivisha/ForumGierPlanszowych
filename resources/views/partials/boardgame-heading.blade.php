...
<div class="mb-4 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold">{{ __('translation.navigation.boardgames') }}</h1>
    </div>
    
    @can('create', App\Models\BoardGame::class)
        <flux:button 
            variant="primary" 
            icon="plus"
            :href="route('board-games.create')" 
            wire:navigate>
            {{ __('boardgames.actions.create') }}
        </flux:button>
    @endcan
</div>
